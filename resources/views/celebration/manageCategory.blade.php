  ...
  <table class="table table-striped">
    ...
    <tbody>
      ...
      <tr>
        ...
        <td><a href="{{ url('/edit_celebration_category/'.$category->id) }}"> Edit </a>|<a href="{{ url('/delete_celebration_category/'.$category->id) }}"> Delete </a></td>
      </tr>
     @endforeach
    </tbody>
  </table
...
{{-- {{ $all_celebration_category->links() }} --}}
