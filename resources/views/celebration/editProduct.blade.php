...
<form action="{{ url("/update_celebration_product") }}" method="post" enctype="multipart/form-data">
    @csrf
  ...
  <div class="col-sm-10">
    <select class="form-control" id="productCategory" name="productCategory">
      <option>Select product category</option>
              @foreach(App\CelebrationCategory::all() as $category)
...
<div class="form-group">
  ...
  <div class="col-sm-10">
    ...
    <img src="{{ asset('/uploads/CelebrationPic') }}/{{ $product->productPicture }}" width="100">
  </div>
</div>
