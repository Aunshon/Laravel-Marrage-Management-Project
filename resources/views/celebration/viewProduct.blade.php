...
<hr>
<img src="{{ asset('/uploads/CelebrationPic') }}/{{ $product->productPicture }}" width="300"><br>
<table>
  <tr>
    <td>Product Name</td><td>:</td><td>{{ $product->productName }}</td>
  </tr>
  <tr>
    <td>Category Name</td><td>:</td><td>{{ App\CelebrationCategory::find($product->categoryId)->categoryName }}</td>
  </tr>
  <tr>
...
<a href="{{ url('/manage_celebration_product') }}">Back to manage product</a>
<br><br><br>
