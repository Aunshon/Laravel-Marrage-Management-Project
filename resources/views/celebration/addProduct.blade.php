...
<h1 class="text-center mt-5" >Add Celebration Product</h1>
...
<div class="container">
	{{ Session::get('msg') }}
<hr>
{{-- {!! Form::open(['url'=>'/save-product', 'method'=>'POST', 'enctype'=>'multipart/form-data', 'class'=>'form-horizontal']) !!} --}}




<form action="/save_celebration_product" method="post" enctype="multipart/form-data">
    @csrf
    <div class="form-group">
  <label class="control-label col-sm-2" for="productName">Product Name:</label>
  <div class="col-sm-10">
    <input value="{{ old('productName') }}" type="text" class="form-control" id="productName" placeholder="Enter ProductName" name="productName">
  </div>
</div>
  ...
  <div class="col-sm-10">
    <select class="form-control" id="productCategory" name="productCategory">
      <option>Select product category</option>
              @foreach($all_celebration_category as $category)
...
<div class="form-group">
  ...
  <div class="col-sm-10">
    <input value="{{ old('productPrice') }}" type="number" class="form-control" id="productPrice"  name="productPrice">
  </div>
</div>
...
<div class="form-group">
  ...
  <div class="col-sm-10">
    <input value="{{ old('productQuantity') }}" type="number" class="form-control" id="productQuantity"  name="productQuantity">
  </div>
</div>
...
<div class="form-group">
  ...
  <div class="col-sm-10">
    <textarea value="{{ old('productDescription') }}" class="form-control" id="productDescription"  placeholder="Enter product Description" name="productDescription"></textarea>
  </div>
</div>
...
<div class="form-group">
  ...
  <div class="col-sm-10">
    <input value="{{ old('productPicture') }}" type="file"  id="productPicture"  name="productPicture">
  </div>
</div>
